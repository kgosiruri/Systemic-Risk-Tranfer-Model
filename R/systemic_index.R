...
joint_sim_data <- joint_sim_data %>%
  mutate(
    ...
    Freight_Score = sim_scaled[, "Freight_Rate_Change"],
    FRO_Score = sim_scaled[, "FRO_Change"],
    STNG_Score = sim_scaled[, "STNG_Change"],
    DHT_Score = sim_scaled[, "DHT_Change"],
    INSW_Score = sim_scaled[, "INSW_Change"],
    CAD_Score = sim_scaled[, "CAD_Change"],
    BRL_Score = sim_scaled[, "BRL_Change"]
  )
